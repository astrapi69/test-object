...
public class Factory extends Company {
    ...
    protected Factory(FactoryBuilder<?, ?> b) {
        ...
        switch (b.employees == null ? 0 : b.employees.size()) {
            ...
            case 1:
                ...
                break;
            default:
                employees = java.util.Collections.unmodifiableList(new ArrayList<Employee>(b.employees));
        }
        this.employees = employees;
        this.ceo = b.ceo;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (this$ceo == null ? other$ceo != null : !this$ceo.equals(other$ceo)) return false;
        return true;
    }
    ...
    public static abstract class FactoryBuilder<C extends Factory, B extends FactoryBuilder<C, B>> extends CompanyBuilder<C, B> {
        private ArrayList<Employee> employees;
        private Employee ceo;

        private static void $fillValuesFromInstanceIntoBuilder(Factory instance, FactoryBuilder<?, ?> b) {
            b.employees(instance.employees == null ? java.util.Collections.emptyList() : instance.employees);
            b.ceo(instance.ceo);
        }
    ...
    private static final class FactoryBuilderImpl extends FactoryBuilder<Factory, FactoryBuilderImpl> {
